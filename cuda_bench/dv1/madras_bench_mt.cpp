...
void process_range(size_t start, size_t end, uint8_t *file_buf_lines, key_ctx *lines, uint8_t *query_status, madras::dv1::static_trie *trie, bool as_int) {
...
void distribute_lookup(uint8_t *file_buf_lines, key_ctx *lines, size_t total_lines, uint8_t *query_status, madras::dv1::static_trie *trie, size_t num_threads, bool as_int) {
...
int main(int argc, const char *argv[]) {
  ...
  madras::dv1::static_trie *trie = new madras::dv1::static_trie();
